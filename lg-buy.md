...
## GOG
GOG, with its famously DRM-free catalog, naturally has some games for your free operating system. Roughly 23% of GOG's games are marked as Linux-compatible.
...
## Humble Store
Humble Bundle is known largely for selling bundles of Steam keys, but the site also has its own store, and many of its games are DRM-free and available as direct downloads. About 51% of those games are also available for Linux.
